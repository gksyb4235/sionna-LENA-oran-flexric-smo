...
exec ./build/scratch/ns3.48-khu-real-dual-nr-sionna-pooled-default \
  ...
  --N_Ues=300 \
  --ueKpiCsvPath=scenarios/khu-real/runs/seed12_dual_nr_100s_20260827_105347/ue_kpi.csv \
  --cellKpiCsvPath=scenarios/khu-real/runs/seed12_dual_nr_100s_20260827_105347/cell_kpi.csv
