...
exec stdbuf -oL -eL ./build/scratch/ns3.48-khu-real-dual-nr-sionna-pooled-default \
  ...
  --N_Ues=300 \
  --ueKpiCsvPath=scenarios/khu-real/runs/seed12_dual_nr_900s_20260827_014859/ue_kpi.csv \
  --cellKpiCsvPath=scenarios/khu-real/runs/seed12_dual_nr_900s_20260827_014859/cell_kpi.csv
